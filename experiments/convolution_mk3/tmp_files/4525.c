...
#pragma omp parallel for simd  num_threads(14) private(j)
  for (i = 1; i < _PB_NI - 1; ++i)
  {
    #pragma omp target teams distribute parallel for  schedule(static, 2) num_threads(2) dist_schedule(static, 8)
