...
#pragma omp target teams distribute parallel for  schedule(dynamic)   private(j)
  for (i = 1; i < _PB_NI - 1; ++i)
  {
    #pragma omp target teams distribute parallel for simd schedule(dynamic, 8)  dist_schedule(static, 8)
